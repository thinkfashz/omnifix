    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          initial={{ opacity: 1 }}
          exit={{ opacity: 0, scale: reduced ? 1 : 1.035, filter: reduced ? 'none' : 'blur(12px)' }}
        ...
        >
          ...
          <div className="relative flex flex-col items-center px-6 text-center">
            <p className="mb-4 text-[10px] font-black uppercase tracking-[0.42em] text-cyan-200/70">Ecosistema digital</p>
            <motion.h1
              className="text-5xl font-black tracking-[0.16em] text-white drop-shadow-[0_0_28px_rgba(59,130,246,.8)] sm:text-7xl"
            ...
            <motion.p
              className="mt-5 max-w-xl text-[10px] font-semibold uppercase leading-6 tracking-[0.30em] text-sky-200/75 sm:text-xs"
            ...
            <div className="mt-10 h-px w-36 overflow-hidden rounded-full bg-slate-800">
              <div
                className="h-full rounded-full bg-gradient-to-r from-blue-600 via-cyan-300 to-blue-400 shadow-[0_0_16px_rgba(59,130,246,.85)]"
