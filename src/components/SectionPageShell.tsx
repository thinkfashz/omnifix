        ...
        <section className="mx-auto max-w-7xl rounded-[2rem] border border-white/5 bg-white/[0.02] px-6 py-10 md:px-12 md:py-14">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              <p className="text-[10px] font-bold uppercase tracking-[0.35em] text-blue-400">{eyebrow}</p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              {primaryAction ? (
                <Link href={primaryAction.href} className="rounded-full bg-blue-500 px-6 py-4 text-center text-[11px] font-black uppercase tracking-[0.22em] text-white transition hover:bg-white hover:text-blue-700">
                  {primaryAction.label}
                </Link>
              ) : null}
              {secondaryAction ? (
                <Link href={secondaryAction.href} className="rounded-full border border-blue-400/35 px-6 py-4 text-center text-[11px] font-bold uppercase tracking-[0.22em] text-blue-300 transition hover:bg-blue-400/10">
      ...
      <footer className="border-t border-white/5 px-4 py-10 md:px-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <p className="text-center text-[10px] uppercase tracking-[0.25em] text-zinc-500">
            Omnifix · Tecnología, automatización y comercio inteligente.
          </p>
        </div>
      </footer>
    </div>
